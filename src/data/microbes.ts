...
// `glow` is the habitat hue used for surrounding UI accents.
...
export interface Microbe {
  ...
  blurb: string;
  glow: GlowKey;
  /** Authentic fact-sheet colour for the artwork. */
  color: string;
}
...
export const MICROBES: Microbe[] = [
  ...
  },
  {
    ...
    blurb:
      'Found in soil and inside the root nodules of leguminous plants like peas, beans and clover. Through nitrogen fixation, rhizobia convert nitrogen gas from the air into a form plants can use to grow; in exchange they gain energy and nutrients from the plant — a symbiotic relationship.',
    glow: 'lime',
    color: '#ef8fbf',
  },
  ...
  // ---- Café ----
  {
    ...
    blurb:
      'Found on virtually every surface and a harmless commensal in the gut, Saccharomyces reproduces by budding — a small cell grows off the parent. Saccharomyces cerevisiae was the first eukaryote to have its full genome sequenced, and is used to make wine, beer and bread.',
    glow: 'amber',
    color: '#ef8a3a',
  },
  ...
  // ---- Gut ----
  {
    ...
    blurb:
      'Found in the gut, Bifidobacterium can make up 60–70% of a baby’s gut microbiota and about 10% in healthy adults. Strains like Bifidobacterium bifidum are beneficial for gut health, found in fermented foods like yoghurt and cheese, and used to treat ulcerative colitis and IBS.',
    glow: 'magenta',
    color: '#9b6fc0',
  },
  {
